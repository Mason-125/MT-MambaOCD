...
import rmsm
from rmsm.parallel import is_module_wrapper
...
class BaseRunner(metaclass=ABCMeta):
    ...
    def register_hook(self,
        ...
        """
        # assert isinstance(hook, Hook)  # eval Hook需要注册进来
    ...
    def register_hook_from_cfg(self, hook_cfg: Dict) -> None:
        ...
        hook = rmsm.build_from_cfg(hook_cfg, HOOKS)
    ...
    def register_lr_hook(self, lr_config: Union[Dict, Hook, None]) -> None:
        if lr_config is None:
            ...
            hook = rmsm.build_from_cfg(lr_config, HOOKS)
        else:
            hook = lr_config
    ...
    def register_momentum_hook(
        ...
        if isinstance(momentum_config, dict):
            ...
            hook = rmsm.build_from_cfg(momentum_config, HOOKS)
        else:
    ...
    def register_optimizer_hook(
        ...
        if isinstance(optimizer_config, dict):
            ...
            hook = rmsm.build_from_cfg(optimizer_config, HOOKS)
        else:
    ...
    def register_checkpoint_hook(
        ...
        if isinstance(checkpoint_config, dict):
            ...
            hook = rmsm.build_from_cfg(checkpoint_config, HOOKS)
        else:
    ...
    def register_logger_hooks(self, log_config: Optional[Dict]) -> None:
        ...
        for info in log_config['hooks']:
            logger_hook = rmsm.build_from_cfg(
    ...
    def register_timer_hook(
        ...
        if isinstance(timer_config, dict):
            ...
            hook = rmsm.build_from_cfg(timer_config_, HOOKS)
        else:
            hook = timer_config
    ...
    def register_profiler_hook(
        ...
        if isinstance(profiler_config, dict):
            ...
            hook = rmsm.build_from_cfg(profiler_config, HOOKS)
        else:
