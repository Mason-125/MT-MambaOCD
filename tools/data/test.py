...
def main(path):
    ...
    save_file = 'fold6_133'
    checkpoint_path = cfg.work_dir + '/' + save_file + '/best_precision_epoch_95.pth'
    ...
    args_out = cfg.work_dir + "./result_show_dir/" + save_file + ".json"
    args_out_items = 'all'
    if rank == 0:
        results = {}
        logger = get_root_logger()

        # print("test_output=", outputs)
...
if __name__ == '__main__':
    path = "../../configs/googlenet/raman_oral_cancer.py"
    main(path)
