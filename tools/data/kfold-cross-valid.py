...
def train_single_fold(cfg, fold, seed, labels_f, distributed=False, test_data=True):
    # create the work_dir for the fold
    work_dir = osp.join(cfg.work_dir, f'fold{fold}_{labels_f[0]}{labels_f[1]}{labels_f[2]}')
    ...
    cfg.model.head.labels_f = labels_f
...
def main(config_path):
    ...
    # seed = init_random_seed(cfg.get('seed')) 260318186, 3704
    seed = 65660946
    ...
    for fold in folds:
        ...
        train_single_fold(cfg_, fold, seed, labels_f=[2, 3, 3])


if __name__ == '__main__':
    main("../../configs/Mamba/raman_oral_cancer.py")
